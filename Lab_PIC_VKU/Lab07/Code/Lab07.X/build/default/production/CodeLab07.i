...
void main(void){
    ...
    PWM_init();
    while(1){
       if(RD0 == 1) direction_motor(1);
       else direction_motor(0);
       if(RD1 == 1 && RD2 == 0 && RD3 == 0 && RD4 == 0 ) PWM_duty(0);
       else if(RD1 == 0 && RD2 == 1 && RD3 == 0 && RD4 == 0 ) PWM_duty(500);
       else if(RD1 == 0 && RD2 == 0 && RD3 == 1 && RD4 == 0 ) PWM_duty(900);
       else if(RD1 == 0 && RD2 == 0 && RD3 == 0 && RD4 == 1 ) PWM_duty(1023);
       else PWM_duty(0);
