...
char keypad_scanner(void) {
    ...
    if (RB7 == 0) { _delay((unsigned long)((100)*(20000000/4000.0))); while (RB7==0); return '/'; }
    ...
    if (RB4 == 0) { _delay((unsigned long)((100)*(20000000/4000.0))); while (RB4==0); return 'c'; }
